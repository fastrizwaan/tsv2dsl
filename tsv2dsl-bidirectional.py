...
#use comment the above and uncomment the below
#if you want to use date+time
...
for line in file:
    ...
    line = line.strip()         #remove extra spaces and tabs
...
#    print("info: Checking if Dictionary name and Language provided properly!"
    if dictionaryName == "":
        print("Error: Dictionary name not provided")
    if indexLanguage == "":
        print("Error: Index language not provided")
    if contentsLanguage == "":
        print("Error: Index language not provided")
    ...
    if dictionaryName == "" or indexLanguage == "" or contentsLanguage == "" or \
           smallIndex == "" or smallContents == "":
        print(line)
        print("Missing Dictionary header, it should be like this:")
        print('*'*50)
